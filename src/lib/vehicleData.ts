...
export const VEHICLE_MAKES: Record<string, string[]> = {
  ...
  BMW: ['1 Series', '2 Series', '3 Series', '4 Series', '5 Series', '6 Series', '7 Series', '8 Series', 'X1', 'X3', 'X4', 'X5', 'X6', 'X7', 'M3', 'M4', 'M5', 'i3', 'i4', 'i7', 'i8', 'iX', 'Z4'],
  Buick: ['Encore', 'Encore GX', 'Envision', 'Enclave'],
  Cadillac: ['ATS', 'CTS', 'STS', 'DTS', 'CT4', 'CT5', 'CT6', 'SRX', 'XT4', 'XT5', 'XT6', 'Escalade', 'Escalade ESV', 'Lyriq'],
  Chevrolet: ['Sonic', 'Spark', 'Cruze', 'Malibu', 'Impala', 'Camaro', 'Corvette', 'Corvette Z06', 'Trax', 'Trailblazer', 'Equinox', 'Blazer', 'Traverse', 'Tahoe', 'Suburban', 'Colorado', 'Silverado 1500', 'Silverado 2500', 'Silverado 3500', 'Silverado EV', 'Express Van', 'Bolt EV'],
  Chrysler: ['300', 'Pacifica'],
  Dodge: ['Charger', 'Challenger', 'Magnum', 'Hornet', 'Journey', 'Durango', 'Caravan', 'Grand Caravan', 'Ram 1500', 'Ram 2500', 'Ram 3500'],
  Ford: ['Fiesta', 'Focus', 'Fusion', 'Taurus', 'Mustang', 'Mustang Shelby GT500', 'Mustang Dark Horse', 'C-Max', 'Transit Connect', 'Maverick', 'Ranger', 'F-150', 'F-150 Raptor', 'F-150 Lightning', 'F-250', 'F-350', 'Transit', 'Escape', 'Bronco Sport', 'Bronco', 'Edge', 'Flex', 'Explorer', 'Expedition', 'Expedition MAX', 'Mustang Mach-E'],
  Genesis: ['G70', 'G80', 'G90', 'GV60', 'GV70', 'GV80'],
  GMC: ['Canyon', 'Sierra 1500', 'Sierra 2500', 'Sierra 3500', 'Terrain', 'Acadia', 'Yukon', 'Yukon XL', 'Hummer EV'],
  Honda: ['Fit', 'CR-Z', 'Civic', 'Civic Type R', 'Civic Si', 'Accord', 'Insight', 'HR-V', 'Element', 'CR-V', 'Passport', 'Pilot', 'Ridgeline', 'Odyssey', 'Prologue'],
  Hummer: ['H1', 'H2', 'H3'],
  ...
  'Mercedes-Benz': ['A-Class', 'C-Class', 'C63 AMG', 'E-Class', 'E63 AMG', 'S-Class', 'CLA', 'CLS', 'SL', 'SLC', 'SLK', 'AMG GT', 'GLA', 'GLB', 'GLC', 'GLE', 'GLS', 'GL-Class', 'ML-Class', 'G-Class', 'G63 AMG', 'R-Class', 'EQS', 'EQE'],
  ...
  Porsche: ['718 Cayman', 'Cayman GT4', '911', '911 GT3', '911 GT3 RS', '911 Turbo', 'Panamera', 'Macan', 'Cayenne', 'Taycan'],
  ...
  Toyota: ['Yaris', 'Corolla', 'GR Corolla', 'Matrix', 'Camry', 'Avalon', 'Prius', 'GR86', 'Supra', 'C-HR', 'Corolla Cross', 'RAV4', 'Venza', 'FJ Cruiser', 'Highlander', '4Runner', 'Sequoia', 'Tacoma', 'Tundra', 'Sienna', 'bZ4X', 'Land Cruiser'],
...
export const VEHICLE_MODEL_SIZES: Record<string, Record<string, 'small' | 'suv' | 'truck'>> = {
  ...
  BMW: {
    '1 Series': 'small', '2 Series': 'small', '3 Series': 'small', '4 Series': 'small', '5 Series': 'small', '6 Series': 'small', '8 Series': 'small', 'M3': 'small', 'M4': 'small', 'M5': 'small', 'i3': 'small', 'i4': 'small', 'i8': 'small', 'Z4': 'small',
  ...
  Chevrolet: {
    'Spark': 'small', 'Malibu': 'small', 'Camaro': 'small', 'Corvette': 'small', 'Corvette Z06': 'small', 'Bolt EV': 'small', 'Trax': 'small', 'Cruze': 'small', 'Impala': 'small', 'Sonic': 'small',
  ...
  Ford: {
    'Mustang': 'small', 'Mustang Shelby GT500': 'small', 'Mustang Dark Horse': 'small', 'Fiesta': 'small', 'Focus': 'small', 'Fusion': 'small', 'Taurus': 'small', 'C-Max': 'small', 'Transit Connect': 'small',
    'Escape': 'suv', 'Bronco Sport': 'suv', 'Bronco': 'suv', 'Edge': 'suv', 'Mustang Mach-E': 'suv',
    'Maverick': 'truck', 'Ranger': 'truck', 'F-150': 'truck', 'F-150 Raptor': 'truck', 'F-150 Lightning': 'truck', 'F-250': 'truck', 'F-350': 'truck', 'Explorer': 'truck', 'Expedition': 'truck', 'Expedition MAX': 'truck', 'Flex': 'truck', 'Transit': 'truck',
  },
  Genesis: {
  ...
  Honda: {
    'Civic': 'small', 'Civic Type R': 'small', 'Civic Si': 'small', 'Accord': 'small', 'Insight': 'small', 'HR-V': 'small', 'Fit': 'small', 'CR-Z': 'small',
  ...
  'Mercedes-Benz': {
    'A-Class': 'small', 'C-Class': 'small', 'C63 AMG': 'small', 'E-Class': 'small', 'E63 AMG': 'small', 'S-Class': 'small', 'CLA': 'small', 'CLS': 'small', 'EQS': 'small', 'EQE': 'small', 'SLK': 'small', 'SLC': 'small', 'SL': 'small', 'AMG GT': 'small',
    'GLA': 'suv', 'GLB': 'suv', 'GLC': 'suv', 'GLE': 'suv', 'ML-Class': 'suv',
    'GLS': 'truck', 'G-Class': 'truck', 'G63 AMG': 'truck', 'R-Class': 'truck', 'GL-Class': 'truck',
  },
  Mercury: {
  ...
  Porsche: {
    '718 Cayman': 'small', 'Cayman GT4': 'small', '911': 'small', '911 GT3': 'small', '911 GT3 RS': 'small', '911 Turbo': 'small', 'Panamera': 'small', 'Taycan': 'small',
    'Macan': 'suv',
    'Cayenne': 'truck',
  },
  RAM: {
  ...
  Toyota: {
    'Corolla': 'small', 'GR Corolla': 'small', 'Camry': 'small', 'Prius': 'small', 'GR86': 'small', 'Supra': 'small', 'Corolla Cross': 'small', 'Avalon': 'small', 'Yaris': 'small', 'C-HR': 'small', 'Matrix': 'small',
