        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#ffffff;border-radius:8px;padding:32px;">
          <tr>
            <td style="font-size:16px;line-height:1.6;color:#222;">
              ...
              <p style="margin:0 0 16px;">Us again. Hope ${vehiclePhrase} still looks sharp.</p>
              ...
              <p style="margin:0 0 16px;font-size:16px;color:#4a4a4a;">Already left one? Thank you, ignore this. Or hit reply if you'd rather share your thoughts directly.</p>
...
Us again. Hope ${vehiclePhrase} still looks sharp.
